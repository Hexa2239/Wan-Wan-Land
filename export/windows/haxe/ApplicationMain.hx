...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Wan Wan Land", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Wan Wan Land", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "22";
		app.meta["company"] = "Hexa2239";
		app.meta["file"] = "Wan Wan Land";
		app.meta["name"] = "Wan Wan Land";
